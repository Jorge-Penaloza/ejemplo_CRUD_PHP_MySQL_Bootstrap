...
if($sw)
{
    ...
    if($conexion->buscar("autos",$campos,$condicion))
    {
        header("Location: insertar.php?error=3");
    } 
    else
    {
        if($conexion->insertar('autos',$campos,$value))
            header("Location: insertar.php?error=2");
        else
